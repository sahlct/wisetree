...
export default function ThoughtFlow() {
  return (
    <div className="py-10 z-30 relative w-full min-h-screen flex flex-col items-center bg-white md:rounded-b-[80px] rounded-b-[40px] overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 w-full px-6 md:py-12 py-8 relative">
        ...
        <div className="w-full md:w-1/3 flex justify-end">
          <img 
            src={image4} 
            alt="Brand Identity" 
            className="mr-20 max-h-[400px] md:max-h-[550px] h-auto rounded-xl rotate-[-5deg] shadow-lg grayscale-50 transition duration-300 hover:grayscale-0"
          />
        </div>
